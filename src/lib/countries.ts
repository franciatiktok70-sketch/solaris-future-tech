...
// Curated ISO list w/ dial codes and flag emojis. Sorted alphabetically by name (ES-neutral).
export const COUNTRIES: Country[] = [
  ...
  { code: "BM", name: "Bermudas", dial: "1441", flag: "🇧🇲" },
  ...
  { code: "EH", name: "Sáhara Occidental", dial: "212", flag: "🇪🇭" },
...
export const DEFAULT_COUNTRY = COUNTRIES.find((c) => c.code === "VE")!;
